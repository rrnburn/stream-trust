      ...
      <div className="flex flex-col h-[calc(100vh-2rem)] gap-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" variant="destructive" onClick={() => logger.clear()}>
        ...
        <ScrollArea className="flex-1 rounded-lg border border-border bg-card p-2 font-mono text-xs">
          ...
          {filtered.map(entry => (
            <div key={entry.id} className="flex gap-2 py-0.5 border-b border-border/30 last:border-0">
              ...
              <span className="text-primary/70 shrink-0">[{entry.component}]</span>
